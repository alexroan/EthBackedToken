...
const MockEthBackedToken = artifacts.require('./MockEthBackedToken.sol')

const EVM_REVERT = 'VM Exception while processing transaction: revert'

require('chai').use(require('chai-as-promised')).should()

contract('EthBackedToken', (accounts) => {
  ...
  beforeEach(async () => {
    ...
    token = await MockEthBackedToken.new(oracle.address, 'Name', 'Symbol', { from: deployer })
  })
